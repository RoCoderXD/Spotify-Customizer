...
if not os.path.exists(installdir):
    ...
    installdir = (desktop)
download_github_files("https://github.com/RoCoderXD/Spotify-Customizer/", ["SpotifyCustomizerAutoStart.pyw", "main.pyw", "Spotify-Customizer.py", "theme.json", "uninstall.py", "requirements.txt"], installdir+"\\Spotify-Customizer")
